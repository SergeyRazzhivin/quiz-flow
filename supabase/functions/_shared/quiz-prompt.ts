...
- Располагай правильные варианты вразнобой: позиция правильного ответа должна меняться
  от вопроса к вопросу, не ставь его всегда первым или на одной и той же позиции.
- Соблюдай запрошенные количество вопросов и уровень сложности.
- Поле "description" — связное описание теста объёмом 30–50 слов: о чём тест,
  какие темы и разделы материала он охватывает и какие знания проверяет.
