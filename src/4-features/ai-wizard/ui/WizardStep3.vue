    ...
    <div class="space-y-2">
      ...
      <div class="inline-flex h-9 w-full items-center justify-center rounded-lg bg-neutral-800 p-1">
        <button
          ...
          :key="d.value"
          type="button"
          class="inline-flex flex-1 items-center justify-center whitespace-nowrap rounded-md px-3 py-1 text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500"
          :class="
