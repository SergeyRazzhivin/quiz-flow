    ...
    <div class="flex flex-col gap-6 md:flex-row">
      ...
      <div class="flex flex-1 flex-col gap-4">
        <input
          ...
          class="w-full rounded-md border border-transparent bg-transparent px-2 py-1 text-2xl font-semibold text-neutral-50 transition-colors hover:border-neutral-800 focus:border-neutral-700 focus:outline-none"
        >
        ...
        <textarea
          ...
          class="w-full resize-none rounded-2xl border border-neutral-800 bg-[#101010] px-3 py-2 text-sm shadow-sm placeholder:text-neutral-500 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-orange-500"
        />
