...
<template>
  <div>
    ...
    <textarea
      ...
      class="mt-2 w-full resize-none rounded-md border border-neutral-700 bg-neutral-900 px-3 py-2 text-sm shadow-sm placeholder:text-neutral-500 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-orange-500"
    />
