...
<template>
  <!-- UI-SPEC section 2 TakingHeader: h-14, bg-neutral-900 border-b border-neutral-800, px-4 py-3 -->
  <header class="flex h-14 items-center gap-4 border-b border-neutral-800 bg-neutral-900 px-4 py-3">
