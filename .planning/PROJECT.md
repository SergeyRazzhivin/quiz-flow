...
## Current Milestone: v1.1 Password Recovery

**Goal:** Дать пользователю возможность сбросить забытый пароль через ссылку на email и установить новый.

**Target features:**
- "Забыли пароль?" на странице входа → форма запроса с email
- Email со ссылкой через встроенный Supabase SMTP (для MVP rate limit ~2/час приемлем)
- Страница установки нового пароля по recovery-токену из ссылки
